...
public class ConstantsText {
    ...
    public static final String PRIVACY_POLICY = "<!DOCTYPE html>\n" +
            ...
            "                    Emil Todorov built the Sentinel app as\n" +
            ...
            "                    Sentinel unless otherwise defined in this Privacy\n" +
            "                    Policy.\n" +
    ...
    public static final String DISCLAIMER = "<h1>Disclaimer</h1>\n" +
            "\n" +
            "<p>Last updated: August 02, 2019</p>\n" +
            "\n" +
            "<p>The information contained on Sentinel mobile app (the \"Service\") is for general information purposes only.</p>\n" +
            "\n" +
            "<p> assumes no responsibility for errors or omissions in the contents on the Service.</p>\n" +
            "\n" +
            "<p>In no event shall  be liable for any special, direct, indirect, consequential, or incidental damages or any damages whatsoever, whether in an action of contract, negligence or other tort, arising out of or in connection with the use of the Service or the contents of the Service.  reserves the right to make additions, deletions, or modification to the contents on the Service at any time without prior notice. This Disclaimer  has been created with the help of <a href=\"https://www.termsfeed.com/\">TermsFeed</a>.</p>\n" +
            "\n" +
    ...
    public static final String TERMS_AND_CONDITIONS = "<!DOCTYPE html>\n" +
            ...
            "                    .\n" +
            "                  </p> <p>\n" +
            "                     is committed to ensuring that the app\n" +
            ...
            "                  </p> <p>\n" +
            "                    The Sentinel app stores and processes personal data\n" +
            ...
            "                    Sentinel app won’t work properly or at all.\n" +
            "                  </p> <p>\n" +
            ...
            "                    using the app.\n" +
            "                  </p> <p>\n" +
            "                    Along the same lines,  cannot always\n" +
            ...
            "                    responsibility.\n" +
            "                  </p> <p>\n" +
            "                    With respect to ’s responsibility for\n" +
            ...
            "                    using the app.  does not promise that\n" +
            ...
            "                    contact me at ek_todorov@abv.bg.\n" +
            "                  </p> <p>\n" +
    ...
    public static final String LICENSE = "Sentinel\n" +
            "    Copyright (C) 2019  Emil Todorov\n" +
            "\n" +
